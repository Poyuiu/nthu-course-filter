...
from src.getdata import get_code_loc, get_code_course
...
class Tabview(customtkinter.CTkFrame):
    ...
    def init(self) -> None:
        ...
        # object position
        self.tabview.tab("department").grid_columnconfigure(
            0, weight=1
        ...
        self.label_department = customtkinter.CTkLabel(
            self.tabview.tab("department"),
            text="Choose department below",
            font=("Arial", 18),
        )
        self.label_department.grid(row=0, column=0, padx=10, pady=10)
        self.department_combobox = customtkinter.CTkOptionMenu(
            self.tabview.tab("department"),
            values=self.AllDep,
        ...
        self.location_combobox = customtkinter.CTkOptionMenu(
            self.tabview.tab("location"),
            values=self.AllLoc,
            command=self.setLoc,
            dynamic_resizing=False,
