...
from src.tabview import Tabview
from src.checkboxfilter import CheckBoxFilter
...
class LeftSideBar(customtkinter.CTkFrame):
    ...
    def change_scaling_event(self, new_scaling: str):
        ...
        self.mother_widget.geometry(
            f"{int(1300 * new_scaling_float)}x{int(700 * new_scaling_float)}"
        )
