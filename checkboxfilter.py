...
class CheckBoxFilter(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.checkbox_3 = customtkinter.CTkCheckBox(master=self.label_content, text="老師")
        self.checkbox_3.grid(row=3, column=0, padx=(10), pady=(10, 10), sticky="n")

        self.checkbox_4 = customtkinter.CTkCheckBox(master=self.label_content, text="語言")
        self.checkbox_4.grid(row=1, column=1, pady=(10, 10), sticky="n")

        self.checkbox_5 = customtkinter.CTkCheckBox(master=self.label_content, text="人限")
